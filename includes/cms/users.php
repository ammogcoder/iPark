...
<?php 
	if(isset($_POST['addUserBtn'])){
		$this->addAdminUser($_POST['username'],$_POST['password'],$_POST['fullname'],$_POST['mobileNo'],1,"?users");
	}elseif(isset($_POST['activateBtn'])){
		$this->activateAccount($_POST['activateBtn'],1,"login","?users",1);
	}elseif(isset($_POST['deactivateBtn'])){
		$this->activateAccount($_POST['deactivateBtn'],0,"login","?users",1);
	}elseif(isset($_POST['deleteBtn'])){
		$this->deleteUserAccount($_POST['deleteBtn'],"login","?users",1);
	}elseif(isset($_POST['chngpwdBtn'])){
		$this->resetUserPassword($_POST['user'],$_POST['password'],"login","?users");
	}
?>
...
<div id="resetPassword" class="modal fade">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="?users" class="form" id="chngpwdForm">
					<div class="form-group">
						<label for="user">User:</label>
						<select name="user" id="user" class="form-control" required>
							<?php 
								$this->genUsersOption(1);
							?>
						</select>
					</div>
					<div class="form-group">
