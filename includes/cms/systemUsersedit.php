    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="?systemUsers&edit" class="form" id="userEdit">
...
<?php
    if(isset($_POST['updateUserBtn'])){
        $this->updateUserProfile($_SESSION['useredit'],$_POST['username'],$_POST['fullname'],$_POST['mobileNo'],"?systemUsers");
    }
?>
