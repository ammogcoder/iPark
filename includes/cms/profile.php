<?php 
	$details=$this->getFullDetailsId($_SESSION['vsoftadmin'],"login");
?>
			...
			<div class="modal-body">
				<form method="post" action="#" class="form well" id="profileForm">
					<div class="form-group">
						...
						<input type="text" id="username" name="username" class="form-control" placeholder="User Name" value="<?php echo $details[1]; ?>" required autofocus/>
					</div>
					<div class="form-group">
						<label for="fullname">Full Name:</label>
						<input type="text" id="fullname" name="fullname" class="form-control" placeholder="Full Name" value="<?php echo $details[3]; ?>" required/>
					</div>
					<div class="form-group">
						<label for="mobileNo">Mobile Number:</label>
						<input type="text" id="mobileNo" name="mobileNo" class="form-control" placeholder="Mobile Number" value="<?php echo $details[4]; ?>" required/>
					</div>
					<div class="form-group">
...
<?php 
	if(isset($_POST['updateBtn'])){
		$this->updateAdminProfile2($_SESSION['vsoftadmin'],$_POST['username'],$_POST['fullname'],$_POST['mobileNo']);
	}
?>
