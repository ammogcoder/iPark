...
?>
  <header class="main-header">
    ...
    <a href="?home" class="logo">
      ...
      <span class="logo-mini"><b>GC</b>R</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg" style="font-family: flower"><b>Stratek</b> Solutions</span>
    </a>
      ...
      <div class="modal-body hold-transition lockscreen">
        <div class="lockscreen-wrapper" id="view1">
            <div class="lockscreen-logo">
              <a href="#" style="font-size: 23px;"><b>Gold Coast</b> Restaurant</a>
            </div>
            <!-- User name -->
            <div class="lockscreen-name"><?php echo $userDetails[3]; ?></div>
...
$('#unlockBtn').click(function(){
    ...
    $.post('ajax.php',{'unlock':password},function(data){
      if(data==1){
        ...
        alertify.alert('Gold Coast Restaurant','Invalid password');
      }
    });
});
