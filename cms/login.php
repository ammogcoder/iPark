<?php 
  ...
  $stratek = new Stratek();
  $stratek->checkIfLoggedIn("stratekadmin");
  $stratek->activatessl();
?>
<!DOCTYPE html>
<html>
...
<body style="background: linear-gradient(to bottom, rgba(0,0,0,0.6) 0%,rgba(0,0,0,0.6) 100%), url('images/bg.png'); background-size: 100%;">
      ...
      <div class="row" style="margin: 15px;">
        ...
        <div class="col-md-4">
          <form class="form-signin form well br" method="post" action="#" id="signin1" style="background-color: #fff;">
            ...
            <h3 style='font-family: helvetica; font-size: 20px; color: grey;' class="form-signin-heading"><center>Management System</center></h3>
